...
from multitenancy.settings import views as settings_views
...
router.register(
    r"plans",
    subscriptions_views.PlanViewSet,
    basename="plans",
)
router.register(
    r"subscriptions", subscriptions_views.SubscriptionsViewSet, basename="subscriptions"
)
router.register(
    r"product-types", subscriptions_views.ProductTypeViewSet, basename="product_type"
)
...
router.register(
    r"billing/payment-gateways",
    billing_views.PaymentGateWayViewSet,
...
router.register(r"settings/logo", settings_views.LogoViewSet, basename="logo_settings")
